...
const char* ssid = "iPhone de Juh";
const char* password = "engenharia";

// Insert Firebase project API Key
#define API_KEY "AIzaSyDRTbHkwm7FVRk-CgRTnZtoHN-ggo1dyqM"

// Insert Authorized Email and Corresponding Password
#define USER_EMAIL "jucarlassilva@gmail.com"
#define USER_PASSWORD "ju18li09"

// Insert Firebase storage bucket ID e.g bucket-name.appspot.com
#define STORAGE_BUCKET_ID "teste-esp32cam.appspot.com"
